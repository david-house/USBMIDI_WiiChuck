// ======================================================================
// USBMIDI and WiiChuck.v generated from TopDesign.cysch
// 07/30/2017 at 14:34
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\not_v1_0"
`include "C:\Program Files\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\not_v1_0\not_v1_0.v"
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\not_v1_0"
`include "C:\Program Files\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\not_v1_0\not_v1_0.v"
`endif
...
module SW_Tx_UART_v1_50_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("a0c46e05-604b-4fe9-a0ba-14c808cb3295/52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
    ...
    UART_v2_50_0 MIDI_UART (
        ...
        .rx_data(Net_12),
        .rx_clk(Net_13));
    defparam MIDI_UART.Address1 = 0;
    defparam MIDI_UART.Address2 = 0;
    defparam MIDI_UART.EnIntRXInterrupt = 1;
    defparam MIDI_UART.EnIntTXInterrupt = 1;
    defparam MIDI_UART.FlowControl = 0;
    defparam MIDI_UART.HalfDuplexEn = 0;
    defparam MIDI_UART.HwTXEnSignal = 0;
    defparam MIDI_UART.NumDataBits = 8;
    defparam MIDI_UART.NumStopBits = 1;
    defparam MIDI_UART.ParityType = 0;
    defparam MIDI_UART.RXEnable = 1;
    defparam MIDI_UART.TXEnable = 1;
    ...
    USBFS_v3_20_1 USBMIDI (
        .sof(Net_15),
        .vbusdet(1'b0));
    defparam USBMIDI.epDMAautoOptimization = 0;

    SW_Tx_UART_v1_50_2 UART ();
